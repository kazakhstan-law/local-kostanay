...
source: https://zan.gov.kz/client/#!/doc/179941/kaz/14.04.2023
---
...
2. Осы Әдістемеде пайдаланылатын негізгі ұғымдар:
   ...
   4) құрылымдық бөлімшенің/мемлекеттік органның басшысы –Е-2, Е-3 (құрылымдық бөлімшелердің басшылары) санаттарының «Б» корпусының мемлекеттік әкімшілік қызметшісі;
...
11. Жауапты қызметкер бағаланатын қызметшіні бағалау нәтижелерімен ол аяқталған соң екі жұмыс күні ішінде ақпараттық жүйе және/немесе мемлекеттік органдардың интранет-порталы немесе электрондық құжат айналымы жүйесі арқылы таныстыруды қамтамасыз етеді.
