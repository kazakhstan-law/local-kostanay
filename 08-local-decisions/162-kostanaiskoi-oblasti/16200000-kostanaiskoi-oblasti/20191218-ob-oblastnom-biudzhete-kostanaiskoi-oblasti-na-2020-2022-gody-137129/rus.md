...
caused_by:
  ...
  link: https://zan.gov.kz/client/#!/doc/143501/rus
source: https://zan.gov.kz/client/#!/doc/137129/rus/02.06.2020
---
...
1. Утвердить бюджет Костанайской области на 2020-2022 годы согласно приложениям 1, 2 и 3 к настоящему решению соответственно, в том числе на 2020 год в следующих объемах:
   ...
   2) затраты – 270 110 359,7 тысячи тенге;

   3) чистое бюджетное кредитование – 37 681 174,1 тысячи тенге, в том числе:

      бюджетные кредиты – 48 676 162,4 тысячи тенге;

      погашение бюджетных кредитов – 10 994 988,3 тысячи тенге;

   4) сальдо по операциям с финансовыми активами – 123 753,0 тысячи тенге;

   5) дефицит (профицит) бюджета – - 44 274 911,7 тысячи тенге;

   6) финансирование дефицита (использование профицита) бюджета – 44 274 911,7 тысячи тенге.
