...
caused_by:
  ...
  link: https://zan.gov.kz/client/#!/doc/141264/rus
...
1. Утвердить бюджет Костанайской области на 2020-2022 годы согласно приложениям 1, 2 и 3 к настоящему решению соответственно, в том числе на 2020 год в следующих объемах:
   ...
   1) доходы – 243 997 613,5 тысячи тенге, в том числе по:
      ...
      поступлениям трансфертов – 237 004 774,5 тысячи тенге;

   2) затраты – 247 259 890,0 тысяч тенге;

   3) чистое бюджетное кредитование – 42 275 896,8 тысячи тенге, в том числе:

      бюджетные кредиты – 52 390 383,1 тысячи тенге;

      погашение бюджетных кредитов – 10 114 486,3 тысячи тенге;

   4) сальдо по операциям с финансовыми активами – 40 208,0 тысяч тенге;

   5) дефицит (профицит) бюджета – - 45 578 381,3 тысячи тенге;

   6) финансирование дефицита (использование профицита) бюджета – 45 578 381,3 тысячи тенге.
