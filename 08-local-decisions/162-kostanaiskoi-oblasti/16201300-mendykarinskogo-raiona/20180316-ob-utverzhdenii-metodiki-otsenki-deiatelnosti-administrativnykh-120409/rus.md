...
source: https://zan.gov.kz/client/#!/doc/120409/rus/16.03.2018
---
...
41. Ознакомление служащего корпуса «Б» с результатами оценки осуществляется в письменной форме. В случае отказа служащего от ознакомления, составляется акт в произвольной форме, который подписывается отделом правовой и кадровой работы двумя другими служащими государственного органа.

42. Отказ служащего корпуса «Б» от ознакомления не является препятствием для внесения результатов оценки в его послужной список. В данном случае отделом правовой и кадровой работы результаты оценки служащему корпуса «Б» направляются посредством интранет - портала государственных органов.
