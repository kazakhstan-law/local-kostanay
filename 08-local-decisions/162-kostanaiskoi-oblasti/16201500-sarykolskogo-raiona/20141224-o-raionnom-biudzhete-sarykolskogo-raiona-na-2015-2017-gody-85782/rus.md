...
source: https://zan.gov.kz/client/#!/doc/85782/rus/24.12.2014
---
...
1. Утвердить районный бюджет Сарыкольского района на 2015 - 2017 годы согласно приложениям 1, 2 и 3-соответственно, в том числе на 2015 год в следующих объемах:
   ...
   1) доходы – 2 839 202,0 тысячи тенге, в том числе по:
      ...
      поступлениям трансфертов – 2 309 037,0 тысяч тенге;

   2) затраты – 2 839 202,0 тысячи тенге;

   3) чистое бюджетное кредитование – 25 233,0 тысячи тенге, в том числе:

      бюджетные кредиты – 32 703,0 тысячи тенге;

      погашение бюджетных кредитов – 7 470,0 тысяч тенге;

   4) сальдо по операциям с финансовыми активами – 0,0 тысяч тенге;

   5) дефицит (профицит) бюджета – -25 233,0 тысячи тенге;

   6) финансирование дефицита (использование профицита) бюджета – 25 233,0 тысячи тенге.
